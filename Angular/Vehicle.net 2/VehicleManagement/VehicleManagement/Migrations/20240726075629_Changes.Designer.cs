...
namespace VehicleManagement.Migrations
{
    ...
    [Migration("20240726075629_Changes")]
            ...
            modelBuilder.Entity("VehicleManagement.Entities.ServiceRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ServiceRecordId = 1,
                            CompletionDate = new DateTime(2024, 7, 26, 13, 26, 28, 710, DateTimeKind.Local).AddTicks(1931),
                            ScheduledDate = new DateTime(2024, 7, 19, 13, 26, 28, 710, DateTimeKind.Local).AddTicks(1908),
                            ServiceAdvisorId = 2,
                            Status = 2,
                            VehicleId = 1
                        },
                        ...
                        {
                            ServiceRecordId = 2,
                            ScheduledDate = new DateTime(2024, 7, 23, 13, 26, 28, 710, DateTimeKind.Local).AddTicks(1935),
                            ServiceAdvisorId = 2,
                            Status = 1,
                            VehicleId = 2
                        });
