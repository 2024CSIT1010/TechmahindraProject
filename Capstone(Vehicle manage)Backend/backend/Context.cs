    ...
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                ...
                // Service Advisors
                new User { Id = 2, FirstName = "John", LastName = "Doe", Email = "john.doe@example.com", MobileNumber = "0987654321", AccountStatus = AccountStatus.APPROVED, UserType = UserType.SERVICE_ADVISOR, Password = "password", CreatedOn = DateTime.Now },
                ...
                new User { Id = 5, FirstName = "Michael", LastName = "Williams", Email = "michael.williams@example.com", MobileNumber = "4567890123", AccountStatus = AccountStatus.APPROVED, UserType = UserType.SERVICE_ADVISOR, Password = "password789", CreatedOn = DateTime.Now.AddDays(-15) },
